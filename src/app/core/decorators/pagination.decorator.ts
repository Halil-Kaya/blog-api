...
export const Pagination = createParamDecorator(
    (data:string,ctx:ExecutionContext) : IPagination => {
        ...
        //limit kismini bodyde, eger body de degilse query de ariyor ordada yoksa 5 atiyor
        let limit = request.body.limit ? parseInt(request.body.limit) : (request.query.limit ? parseInt(request.query.limit) : 5); 
